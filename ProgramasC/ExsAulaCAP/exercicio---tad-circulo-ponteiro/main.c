...
int main()
{
  ...
  printf("Circulo 1\n");
  leiaCirculo(&circulo1.centro.x,&circulo1.centro.y,&circulo1.raio);
  escrevaCirculo(circulo1);
  
  printf("Circulo 2\n");
  leiaCirculo(&circulo2.centro.x,&circulo2.centro.y,&circulo2.raio);
...
void leiaCirculo(int *px, int *py, int *pRaio)
{
